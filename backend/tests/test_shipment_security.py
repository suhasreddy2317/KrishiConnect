"""Security tests for shipment status transitions."""
...
DEMO_PASS = "shipsecpass"
BUYER1_USER_PHONE = "+919910000511"
BUYER1_BUYER_PHONE = "+919910000512"
FARMER1_USER_PHONE = "+919910000513"
FARMER1_PHONE = "+919910000514"
FARMER2_USER_PHONE = "+919910000515"
FARMER2_PHONE = "+919910000516"
...
def test_buyer_cannot_mark_shipment_delivered(data):
...
def test_field_agent_can_mark_shipment_delivered(data):
    FA_PHONE = "+919910000516"
    FA_PASS = "fapass"
    pw = hash_password(FA_PASS)
    fa_user = User(name="Field Agent", phone=FA_PHONE, role=UserRole.field_agent, is_active=True, password_hash=pw)
    data.db.add(fa_user)
    data.db.commit()
